...
class DynamicLightsNode extends LightsNode {
  ...
  constructor(options = {}) {
    ...
    this.maxDirectionalLights =
      options.maxDirectionalLights !== undefined ? options.maxDirectionalLights : 8
    ...
    this.maxHemisphereLights =
      options.maxHemisphereLights !== undefined ? options.maxHemisphereLights : 4
