...
class GTAOPass extends Pass {
  ...
  updateGtaoMaterial(parameters) {
    ...
    if (
      parameters.samples !== undefined &&
      parameters.samples !== this.gtaoMaterial.defines.SAMPLES
    ) {
  ...
  updatePdMaterial(parameters) {
    ...
    if (
      parameters.radiusExponent !== undefined &&
      parameters.radiusExponent !== this.pdRadiusExponent
    ) {
