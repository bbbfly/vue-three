var rhino3dm = (() => {
  ...
  return function (config) {
    ...
    var ___wasm_call_ctors = (Module['___wasm_call_ctors'] = function () {
      return (___wasm_call_ctors = Module['___wasm_call_ctors'] = Module['asm']['pa']).apply(
        null,
        arguments
      )
    })
    ...
    var ___errno_location = (Module['___errno_location'] = function () {
      return (___errno_location = Module['___errno_location'] = Module['asm']['ta']).apply(
        null,
        arguments
      )
    })
    var ___getTypeName = (Module['___getTypeName'] = function () {
      return (___getTypeName = Module['___getTypeName'] = Module['asm']['ua']).apply(
        null,
        arguments
      )
    })
