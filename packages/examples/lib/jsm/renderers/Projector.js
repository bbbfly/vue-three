  ...
  constructor() {
    ...
    function RenderList() {
      ...
      function pushTriangle(a, b, c, material) {
        ...
        if (
          (nearDist1 < 0 && nearDist2 < 0 && nearDist3 < 0) ||
        ...
        _clipPos1.set(
          v1.positionScreen.x * w1,
          v1.positionScreen.y * w1,
          v1.positionScreen.z * w1,
          w1
        )
        _clipPos2.set(
          v2.positionScreen.x * w2,
          v2.positionScreen.y * w2,
          v2.positionScreen.z * w2,
          w2
        )
        _clipPos3.set(
          v3.positionScreen.x * w3,
          v3.positionScreen.y * w3,
          v3.positionScreen.z * w3,
          w3
        )
