...
class Memory extends Tab {
  constructor(options = {}) {
    ...
    this.indirectStorageAttributes = new Item(
      'Indirect Storage Attributes',
      createValueSpan(),
      createValueSpan()
    )
  ...
  updateText(inspector) {
    ...
    setText(
      this.indirectStorageAttributes.data[2],
      formatBytes(memory.indirectStorageAttributesSize)
    )
