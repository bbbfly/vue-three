<template>
  <TCanvas :camera="null" @animate="onAnimate">
    <TScene ref="scene">
      <TPerspectiveCamera v-if="!isCameraPerspective" ref="cameraPerspective" :aspect="0.5" :position="[0, 0, 2500]"
        :fov="fov" :near="150" :far="10000" :rotation="[0, Math.PI, 0]" />
...
import { TCanvas, TScene, TPerspectiveCamera, TOrthographicCamera, TMesh, TSphere, TMeshBasicMaterial } from '@vue-three/vue-three'
