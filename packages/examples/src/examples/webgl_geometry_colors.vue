...
import { Color, SRGBColorSpace, BufferAttribute, type Camera, type Scene } from 'three'
import {
  TCanvas,
  TScene,
  TPerspectiveCamera,
...
function setupVertexColors() {
  ...
  const arrayType =
    typeof window.Float16Array !== 'undefined' ? window.Float16Array : window.Float32Array
