        ...
        <TScene background="#1a1a2e">
          ...
          >
            ...
            <TMeshStandardMaterial color="#8B4513" :metalness="0.1" :roughness="0.8">
              <TTexture map-type="map" :repeat="[1, 1]" :url="diffuseTextureUrl" />
              <TTexture map-type="normalMap" :repeat="[1, 1]" :url="normalTextureUrl" />
              <TTexture map-type="roughnessMap" :repeat="[1, 1]" :url="roughnessTextureUrl" />
          ...
          >
            ...
            <TMeshStandardMaterial>
              ...
              <TTexture map-type="normalMap" :url="normalTextureUrl" />
              <TTexture map-type="roughnessMap" :url="roughnessTextureUrl" />
            </TMeshStandardMaterial>
          </TMesh>

          <TMesh
            ref="repeatTextureRef"
            :position="[4, 1.2, 0]"
            :cast-shadow="true"
            :receive-shadow="true"
          >
          ...
          >
            ...
            <TMeshStandardMaterial>
              ...
              <TTexture
                ...
                :url="waterNormal2Url"
              />
              <TTexture map-type="roughnessMap" :repeat="[2, 2]" :url="waterRoughnessUrl" />
            </TMeshStandardMaterial>
          </TMesh>
        </TScene>
      </TCanvas>
